@section('title', __('Municipalities'))
<div>
    <div class="max-w-7xl mx-auto pt-6 px-2">
        <h1 class="text-3xl font-bold text-gray-600 mb-4">{{ __('Municipalities') }}</h1>
    ...
    <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <x-jet-label for="province_id" value="{{ __('Provinces') }}" />
            ...
            {{-- <div class="mt-4">
                ...
                <select id="status"  class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="status" wire:model.debounce.500ms="status">
                    <option>Seleccionar</option>
